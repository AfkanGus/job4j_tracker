...
/*
* 11. Ладьи на шахматной доске
Ладья - это шахматная фигура, которая осуществляет ход по доске только по прямой линии в любом направлении.

Метод принимает две строки, каждая из которых означает координаты клетки в которой находятся ладьи разного цвета. Необходимо определить может ли одна ладья побить другую. Для этого нужно определить стоят ли они на одной линии или нет.
