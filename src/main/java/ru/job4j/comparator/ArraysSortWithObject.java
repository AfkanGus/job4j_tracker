 ...
 * В утилитном классе Arrays есть метод для сортикровк массива объектов
 * void sort(массив, компаратор)
 * Например:
 * Integer[] data = {3,2,1};
 * Arrays.sort(data, Comparator.naturalOrder());//Теперь массив станет{1,2,3}
 * Ваша задача отсортировать массив строк в убывающем порядке и вернуть его,
