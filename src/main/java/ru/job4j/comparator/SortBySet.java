...
/**
 * 2.5 Способы сортировки.
 * Сортировка Collection. Сортировка через создание новой коллекции
 ...
 * <p>
 * т.е. на старое место элемента встает новый, который должен стоять на его месте по порядку.
 * Это первый недостаток использования данных методов.
 * Второй очевидный недостаток, как нам сортировать, например Set.
 * По возможности, если нам не требуется далее работать с исходной
 * коллекцией и пользоваться ее преимуществами, мы можем делать
 * следующее. Для сортировки сетов мы можем создать новый сет уже
 * отсортированный (в случае если у нас есть неотсортированный сет,
 ...
 * <p>
 * Ваша задача получить отсортированный сет по списку строк.
