 ...
 * признаку, но если признаки равны, то сортировать по другому признаку. Для этой
 * задачи существует метод thenComparing().
 ...
 * Ваша задача написать компаратор, который будет упорядочивать
 * пользователей сначала по возрастанию по имени, а потом по убыванию по возрасту.
 */
