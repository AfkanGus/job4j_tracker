...
public class User {
    ...
    /**
     * Класс скатический Строитель -  шаблон Строитель, выносит
     * создание объетка за пределы собственного класса
     */
    static class Builder {
        ...
        /**
         * @param -build() - метод создаст готовый объект
         * @return - вернет экземпяр объекта
         */
        User build() {
            User user = new User();
            user.name = name;
