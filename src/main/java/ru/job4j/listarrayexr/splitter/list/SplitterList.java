 ...
 * Зачем сразу 2 метода, спросите Вы. Ответ простой -
 * для того чтобы определить разное поведение при удалении. Подробнее:
 * <p>
 ...
 * метода исходный список изменился - метод возвращает true.
